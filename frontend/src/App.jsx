...
import { Detailansicht_Anfrage_Hilfe } from './pages/Detailansicht_Anfrage_Hilfe.jsx'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path = "/hilfe/:user_id/request/:request_id" element = {<Detailansicht_Anfrage_Hilfe />} />
