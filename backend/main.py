...
async def testMessageData():
    messages = [
        ...
        Message(chat_id=1, user_id=4, message_text="Hallo Anna, vielen Dank, dass Sie mir helfen möchten!"),
        Message(chat_id=1, user_id=1, message_text="Guten Tag Hans! Gerne helfe ich Ihnen. Können Sie mir sagen, welche Farbe die Lampe am Router hat?"),
        Message(chat_id=1, user_id=4, message_text="Die Lampe blinkt rot. Ist das schlecht?"),
        Message(chat_id=1, user_id=1, message_text="Das bedeutet meist, dass keine Internetverbindung besteht. Versuchen Sie bitte, den Router für 30 Sekunden auszuschalten und dann wieder einzuschalten."),
        Message(chat_id=1, user_id=4, message_text="Okay, ich probiere das jetzt mal..."),
        Message(chat_id=1, user_id=4, message_text="Es funktioniert! Die Lampe ist jetzt grün. Vielen Dank!"),
        Message(chat_id=1, user_id=1, message_text="Sehr gut! Das freut mich. Falls Sie noch Fragen haben, melden Sie sich gerne."),
        
        # Chat 2: Peter hilft Hans mit Passwort (abgeschlossen)
        Message(chat_id=2, user_id=4, message_text="Hallo Peter, ich komme nicht mehr in meine E-Mails..."),
        Message(chat_id=2, user_id=2, message_text="Hallo Hans! Kein Problem, das kriegen wir hin. Welcher E-Mail-Anbieter ist das?"),
        Message(chat_id=2, user_id=4, message_text="Das ist T-Online."),
        Message(chat_id=2, user_id=2, message_text="Okay, gehen Sie auf die T-Online Webseite und klicken Sie auf 'Passwort vergessen'. Dann bekommen Sie eine SMS oder E-Mail zum Zurücksetzen."),
        Message(chat_id=2, user_id=4, message_text="Ah verstehe! Das hat geklappt, ich habe jetzt ein neues Passwort. Danke!"),
        
        # Chat 3: Claudia hilft Gisela mit langsamem Handy
        Message(chat_id=3, user_id=5, message_text="Hallo Claudia, mein Handy ist so langsam geworden..."),
        Message(chat_id=3, user_id=3, message_text="Hallo Gisela! Das können wir zusammen anschauen. Wie viel Speicherplatz haben Sie noch frei?"),
        Message(chat_id=3, user_id=5, message_text="Wie sehe ich das denn?"),
        Message(chat_id=3, user_id=3, message_text="Gehen Sie in die Einstellungen und dann auf 'Speicher'. Dort steht, wie viel Platz noch frei ist."),
    ]
